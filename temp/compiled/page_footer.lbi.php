...
<div class="help_right">
 <img src="themes/ecmoban_mbaobao/images/help_tel.gif">
 
 <ul> <?php if ($this->_var['service_phone']): ?>
...
<div class="block">
    <img src="themes/ecmoban_mbaobao/images/service.gif" style="float:left">
</div>
 <div class="blank"></div>
...
<?php endif; ?> 
  [<a href="http://www.ecmoban.com" target="_blank" title="<?php echo $this->_var['link']['name']; ?>">ecshop模板堂</a>]
 </div>
 </div>
</div>
...
<div id="bottomNav" class="box">
  <div class="bNavList clearfix">
   ...
   <?php $_from = $this->_var['navigator_list']['bottom']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'nav_0_94903500_1357546156');$this->_foreach['nav_bottom_list'] = array('total' => count($_from), 'iteration' => 0);
if ($this->_foreach['nav_bottom_list']['total'] > 0):
    foreach ($_from AS $this->_var['nav_0_94903500_1357546156']):
        $this->_foreach['nav_bottom_list']['iteration']++;
?>
        <a href="<?php echo $this->_var['nav_0_94903500_1357546156']['url']; ?>" <?php if ($this->_var['nav_0_94903500_1357546156']['opennew'] == 1): ?> target="_blank" <?php endif; ?>><?php echo $this->_var['nav_0_94903500_1357546156']['name']; ?></a>
...
?>
      <?php if ($this->_var['im']): ?>
      <a href="http://edit.yahoo.com/config/send_webmesg?.target=<?php echo $this->_var['im']; ?>n&.src=pg" target="_blank"><img src="themes/ecmoban_mbaobao/images/yahoo.gif" width="18" height="17" border="0" alt="Yahoo Messenger" /> <?php echo $this->_var['im']; ?></a>
      <?php endif; ?>
      <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
...
?>
      <?php if ($this->_var['im']): ?>
      <img src="themes/ecmoban_mbaobao/images/msn.gif" width="18" height="17" border="0" alt="MSN" /> <a href="msnim:chat?contact=<?php echo $this->_var['im']; ?>"><?php echo $this->_var['im']; ?></a>
      <?php endif; ?>
      <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
